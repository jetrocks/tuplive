...
<body >
	...
	<span style="font-size:24px; cursor:pointer; border: 2px solid black" onclick="openNav()"><button  ><i  class="fa fa-server" style="color:black;"></i></button></span>
		...
		<div class="box container2 headcolorroundy">
			...
			<div class="col-md-12">
					<table class="table">
						...
						<tbody>
							<tr>
								...
								<td><a href="<?php echo base_url('adminprogview'); ?>">View full schedule</a> | 
										<a href="<?php echo base_url('canceled') ?>" class="confirmation">Cancel schedule</a></td>
							</tr>							
							<tr>
								<td>02</td>
								<td>Program Name 02</td>
								<td><a href="<?php echo base_url('adminprogview'); ?>">View full schedule</a> | 
										<a href="<?php echo base_url('canceled') ?>" class="confirmation">Cancel schedule</a></td>
							</tr>							
							<tr>
								<td>03</td>
								<td>Program Name 03</td>
								<td><a href="<?php echo base_url('adminprogview'); ?>">View full schedule</a> | 
										<a href="<?php echo base_url('canceled') ?>" class="confirmation">Cancel schedule</a></td>
							</tr>							
							<tr>
								<td>04</td>
								<td>Program Name 04</td>
								<td><a href="<?php echo base_url('adminprogview'); ?>">View full schedule</a> | 
										<a href="<?php echo base_url('canceled') ?>" class="confirmation">Cancel schedule</a></td>
							</tr>							
							<tr>
								<td>05</td>
								<td>Program Name 05</td>
								<td><a href="<?php echo base_url('adminprogview'); ?>">View full schedule</a> | 
										<a href="<?php echo base_url('canceled') ?>" class="confirmation">Cancel schedule</a></td>
							</tr>
					...
					<script type="text/javascript">
						...
						if (!confirm('Are you sure you want to cancel this schedule?')) e.preventDefault();
							};
