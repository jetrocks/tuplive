...
<body >
	<div id="mySidenav" class="s-12 sidenav">
		...
		<a href="<?php echo base_url('proglist'); ?>">Program List</a>
		</div>
	...
	<section>
		<div class="box container2 headcolorroundy">
			...
			<div class="col-md-12">
				...
				<button onclick="window.location.href='<?php echo base_url('success') ?>'" class="confirmation" style="color: black;" > Accept </button> 
				<button onclick="window.location.href='<?php echo base_url('decline') ?>'" class="confirmation2" style="color: black;" > Decline </button>
			</div>
		</div>
		<br />
	</section>
	...
	<script type="text/javascript">
						...
						if (!confirm('Do you want to accept this schedule request?')) e.preventDefault();
							};
	...
	<script type="text/javascript">
						...
						var confirmIt = function (e) {
						if (!confirm('Do you want to decline this request?')) e.preventDefault();
							};
						for (var i = 0, l = elems.length; i < l; i++) {
							elems[i].addEventListener('click', confirmIt, false);
							}
