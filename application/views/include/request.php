...
<body class="align">
	...
	<section>
		...
		<div  class="s-6 m-6 l-6 sidetext align">
		...
		<div id="log" class="box s-5 m-5 l-5 boxkular" style="margin:40px; top:50px;">
			...
			<br />
			<br />
			<form action=" <?php echo base_url('confirming'); ?>" class="formy" method="post">
					<div class="line">
					<div class="form-group m-12 s-12">
					<label>TUP Webmail:</label> <input title="Please input TUP Webmail only. (name.surname@tup.edu.ph)" class="form-control" type="email" name="email" pattern="[\w.%+-]+@tup\.edu\.ph" required/>
					<span class="" aria-hidden="true"></span>
					</div>
					</div>
				
					<h4 style="color: white;">Get your Schedule Request Pass as soon as the email is sent to your TUP webmail!</h4>
				<input type="submit" class="btn btn-default btn-success s-12 m-12 l-12" name="submit" />
			</form>
